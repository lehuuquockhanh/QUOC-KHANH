...
public class main {
	...
	public static void main(String[] args) {
		...
		Connection conn = conecttiondatabase.getConnection();
        ...
        sb.append("7. Tim kiem ngay nghi sinh vien. \n");
        sb.append("8. Xoa sinh vien. \n");
        sb.append("9. Xoa lop hoc. \r\n");
		...
		case 4: 
			   ...
			   System.out.println("Dang ky ngay nghi cho sinh vien: \n");
		        ...
		        if(help.isThisDateValid(day, "dd/MM/yyyy")) {
		...
		case 7:
	        ...
	        if(dayOffSearch != null && !dayOffSearch.isEmpty()) {
		        if(help.isThisDateValid(dayOffSearch, "dd/MM/yyyy")) {
